...
unattended once claimed.
  setup      the installers run this: everything after the binary, asked as
             ...
             config, connect, the shell profile (PATH, TOKENDROP_CONFIG and,
             when a wallet was made here, TOKENDROP_WALLET_DIR; Windows: the
             user PATH and TOKENDROP_CONFIG only) and the coding agents
             found here.
